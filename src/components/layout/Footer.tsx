    ...
    <footer className="bg-white border-t border-clara-rosa/20 mt-16">
      <div className="max-w-5xl mx-auto px-4 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="text-center md:text-left">
          <p className="font-display text-2xl text-clara-rosa mb-1">By Clara</p>
          <p className="text-sm text-gray-500">Pulseiras de miçangas feitas com amor 💕</p>
          <p className="text-xs text-gray-400 mt-1">Itaberaí — GO</p>
        </div>
        ...
        <div className="flex flex-col items-center gap-3">
          <a
            ...
            className="flex items-center gap-2 bg-green-500 text-white font-semibold px-5 py-2.5 rounded-2xl hover:bg-green-600 transition-colors text-sm"
          >
      ...
      <div className="border-t border-clara-rosa/10 py-4 text-center">
        <p className="text-xs text-gray-400 flex items-center justify-center gap-1">
          Feito com <Heart size={12} className="text-clara-rosa fill-clara-rosa" /> por By Clara © {new Date().getFullYear()}
        </p>
      </div>
    </footer>
  )
